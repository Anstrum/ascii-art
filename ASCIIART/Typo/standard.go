...
func GetStandard(char string) [][]string {
	...
	parentheseOuvrante := [][]string{ //length 5
		{"  __ "},
		{" / / "},
		{"| |  "},
		{"| |  "},
	...
	parentheseFermante := [][]string{ //length 5
		{" __  "},
		{" \\ \\ "},
		{"  | |"},
		{"  | |"},
